...
int ProtoAudioProcessor::getNumPrograms() { return 8; }
...
void ProtoAudioProcessor::lerpValue(StringRef slider, float& oldval, float newval) {
...
AudioProcessorEditor* ProtoAudioProcessor::createEditor() {
	return new ProtoAudioProcessorEditor(*this,paramcount,state,pots);
}
