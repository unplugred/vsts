...
class ProtoAudioProcessor : public AudioProcessor, public AudioProcessorValueTreeState::Listener, private Timer {
public:
	ProtoAudioProcessor();
	~ProtoAudioProcessor() override;
...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ProtoAudioProcessor)
};
