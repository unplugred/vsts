...
Source: "build\other\{#PluginName}\*.*"; DestDir: "{code:GetVST2Dir|0}\{#PluginName}"; Components: VST64; Flags: recursesubdirs onlyifdoesntexist
;Source: "build\32\{#PluginName}.dll"; DestDir: {code:GetVST2Dir|1}; Components: VST; Flags: ignoreversion
;Source: "build\other\{#PluginName}\*.*"; DestDir: "{code:GetVST2Dir|1}\{#PluginName}"; Components: VST; Flags: recursesubdirs onlyifdoesntexist
Source: "build\64\{#PluginName}.vst3"; DestDir: "{cf64}\VST3\"; Components: VST364; Flags: ignoreversion
Source: "build\other\{#PluginName}\*.*"; DestDir: "{cf64}\VST3\{#PluginName}"; Components: VST364; Flags: recursesubdirs onlyifdoesntexist
;Source: "build\32\{#PluginName}.vst3"; DestDir: "{cf32}\VST3\"; Components: VST3; Flags: ignoreversion
;Source: "build\other\{#PluginName}\*.*"; DestDir: "{cf32}\VST3\{#PluginName}"; Components: VST3; Flags: recursesubdirs onlyifdoesntexist
