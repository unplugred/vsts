...
const String ProtoAudioProcessor::get_preset(int preset_id, const char delimiter) {
	std::ostringstream data;
...
void ProtoAudioProcessor::set_preset(const String& preset, int preset_id, const char delimiter, bool print_errors) {
	String error = "";
...
AudioProcessorValueTreeState::ParameterLayout ProtoAudioProcessor::create_parameters() {
