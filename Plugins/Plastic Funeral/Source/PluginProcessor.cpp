...
const String PFAudioProcessor::get_preset(int preset_id, const char delimiter) {
	std::ostringstream data;
...
void PFAudioProcessor::set_preset(const String& preset, int preset_id, const char delimiter, bool print_errors) {
	String error = "";
...
AudioProcessorValueTreeState::ParameterLayout PFAudioProcessor::create_parameters() {
