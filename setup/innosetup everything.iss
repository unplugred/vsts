...
Source: "build_win\paid\ModMan.vst3"; DestDir: "{commoncf64}\VST3\UnplugRed\"; Components: VST3; Flags: ignoreversion
...
Source: "build_win\paid\ModMan.clap"; DestDir: {code:GetDir|0}; Components: CLAP; Flags: ignoreversion
