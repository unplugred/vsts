				...
				//PAN
					...
					if(channelnum > 1) {
						for(int s = 0; s < numsamples; ++s) {
							...
							if(state[pots.isb?1:0].values[b][m] != .5) {
								for(int c = 0; c < channelnum; ++c) {
									double amplitude = ((double)c)/(channelnum-1);
									if(state[pots.isb?1:0].values[b][m] > .5) amplitude = 1-amplitude;
									wetChannelData[b][c][s] *= 1-amplitude*fabs(state[pots.isb?1:0].values[b][m]-.5)*2;
								}
							}
						}
					}
...
void PrismaAudioProcessor::parameterChanged(const String& parameterID, float newValue) {
	...
	if(parameterID.endsWith("id")) {
		if(state[pots.isb?1:0].id[b][m] == newValue) return;
...
AudioProcessorValueTreeState::ParameterLayout PrismaAudioProcessor::createParameters() {//72  41
	...
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b0m0val"		,"Low Module 1 Value"		,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b0m0id"		,"Low Module 1 Type"		,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b0m1val"		,"Low Module 2 Value"		,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b0m1id"		,"Low Module 2 Type"		,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b0m2val"		,"Low Module 3 Value"		,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b0m2id"		,"Low Module 3 Type"		,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b0m3val"		,"Low Module 4 Value"		,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b0m3id"		,"Low Module 4 Type"		,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b0gain"		,"Low Gain"					,0.0f	,1.0f	,0.5f	));
	...
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b1m0val"		,"Low Mid Module 1 Value"	,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b1m0id"		,"Low Mid Module 1 Type"	,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b1m1val"		,"Low Mid Module 2 Value"	,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b1m1id"		,"Low Mid Module 2 Type"	,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b1m2val"		,"Low Mid Module 3 Value"	,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b1m2id"		,"Low Mid Module 3 Type"	,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b1m3val"		,"Low Mid Module 4 Value"	,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b1m3id"		,"Low Mid Module 4 Type"	,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b1cross"		,"Low Mid Crossover"		,0.0f	,1.0f	,0.25f	));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b1gain"		,"Low Mid Gain"				,0.0f	,1.0f	,0.5f	));
	...
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b2m0val"		,"High Mid Module 1 Value"	,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b2m0id"		,"High Mid Module 1 Type"	,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b2m1val"		,"High Mid Module 2 Value"	,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b2m1id"		,"High Mid Module 2 Type"	,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b2m2val"		,"High Mid Module 3 Value"	,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b2m2id"		,"High Mid Module 3 Type"	,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b2m3val"		,"High Mid Module 4 Value"	,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b2m3id"		,"High Mid Module 4 Type"	,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b2cross"		,"High Mid Crossover"		,0.0f	,1.0f	,0.5f	));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b2gain"		,"High Mid Gain"			,0.0f	,1.0f	,0.5f	));
	...
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b3m0val"		,"High Module 1 Value"		,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b3m0id"		,"High Module 1 Type"		,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b3m1val"		,"High Module 2 Value"		,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b3m1id"		,"High Module 2 Type"		,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b3m2val"		,"High Module 3 Value"		,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b3m2id"		,"High Module 3 Type"		,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b3m3val"		,"High Module 4 Value"		,0.0f	,1.0f	,0.0f	));
	parameters.push_back(std::make_unique<AudioParameterInt		>("b3m3id"		,"High Module 4 Type"		,0		,16		,0		));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b3cross"		,"High Crossover"			,0.0f	,1.0f	,0.75f	));
	parameters.push_back(std::make_unique<AudioParameterFloat	>("b3gain"		,"High Gain"				,0.0f	,1.0f	,0.5f	));
	...
	parameters.push_back(std::make_unique<AudioParameterFloat	>("wet"			,"Wet"						,0.0f	,1.0f	,1.0f	));
