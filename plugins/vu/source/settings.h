...
class VUAudioProcessorSettings : public DocumentWindow, public plugmachine_gui {
public:
	VUAudioProcessorSettings(VUAudioProcessor&, int paramcount, knob*);
	~VUAudioProcessorSettings() override;
...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(VUAudioProcessorSettings)
};
